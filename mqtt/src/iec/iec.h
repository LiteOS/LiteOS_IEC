...
{
    void (*init)(iec_if_t *interface);
    void (*uninit)(iec_if_t *interface);
    void (*connect)(iec_connection_t *nc);
    void (*discon)(iec_connection_t *nc);
    iec_time_t (*poll)(iec_if_t *interface, int timeout_ms);
    int (*send)(iec_connection_t *nc, const void *buf, size_t len);
    int (*recv)(iec_connection_t *nc, void *buf, size_t len);
} iec_if_funcs_t;
